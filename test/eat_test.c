...
static const uint8_t submods_uccs[] = {
    ...
    0x5a, 0xfd, 0x32, 0x2e, 0x0e, 0x03, 0x14, 0xa3,
    0x6f, 0x41, 0x6e, 0x64, 0x72, 0x6f, 0x69, 0x64,
    0x20, 0x41, 0x70, 0x70, 0x20, 0x46, 0x6f, 0x6f,
    0xa1, 0x0e, 0x01, 0x72, 0x53, 0x65, 0x63, 0x75,
    0x72, 0x65, 0x20, 0x45, 0x6c, 0x65, 0x6d, 0x65,
    0x6e, 0x74, 0x20, 0x45, 0x61, 0x74, 0x43, 0x42,
    0x01, 0x23, 0x6d, 0x4c, 0x69, 0x6e, 0x75, 0x78,
    0x20, 0x41, 0x6e, 0x64, 0x72, 0x6f, 0x69, 0x64,
    0xa1, 0x0e, 0x01
};

static const uint8_t xxx[] = {
...
int32_t get_next_test()
{
    ...
    if(result != CTOKEN_ERR_SUCCESS ||
       ...
       q_useful_buf_compare(claim.val.string, Q_USEFUL_BUF_FROM_BYTE_ARRAY_LITERAL(xxx))) {
